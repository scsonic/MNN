...
int main(int argc, const char* argv[]) {
    if (argc < 9) {
        ...
        MNN_PRINT("  model_type       : 0=SD1.5, 1=Taiyi, 2=Sana, 3=ZImage, 4=LongCat, 5=Flux2Klein, 6=Wan2.1, 7=QwenImage2.1\n");
    ...
    } else if (model_type == QWEN_IMAGE_21) {
        MNN_PRINT("Model type is Qwen-Image-2.1 (Qwen3-VL-8B + 7B single-stream DiT)\n");
    } else {
