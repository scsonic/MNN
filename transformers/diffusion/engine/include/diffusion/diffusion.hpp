...
// Forward declare SchedulerConfig (full definition in scheduler.hpp)
struct SchedulerConfig {
    int   trainTimestepsNum  = 1000;
    float shift              = 3.0f;
    bool  useDynamicShifting = false;
    int   baseImageSeqLen = 256;
    int   maxImageSeqLen  = 4096;
...
protected:
    ...
    // Unified scheduler configuration (shared by ZImage, LongCat, Flux2Klein)
